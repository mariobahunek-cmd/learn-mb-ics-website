...
Anyone working with SAP S/4HANA today lands in almost the same place after logging in: the SAP Fiori Launchpad. It's the modern home screen for every user, and it's steadily replacing the classic grey SAP GUI. This article explains, in plain language, what you'll find there — from the tile to personalization.

## In short: your personal home screen in S/4HANA
...
Once you have the launchpad open, you find your way quickly as soon as you know the fixed zones:

- **Header (shell bar)** at the very top, with logo, search, notifications and the user menu
- **Main area** in the center with the apps, organized into **spaces and pages**
- **Navigation** via the menu or the search
...
The SAP Fiori Launchpad is the **role-based home screen** of S/4HANA: a set of tiles that shows you exactly the apps that fit your job. You navigate through spaces and pages, find everything via the central search, and set up your own workspace with personalization and themes. Once you can keep the building blocks apart — tile, space, page, app type — you move around S/4HANA with confidence.
