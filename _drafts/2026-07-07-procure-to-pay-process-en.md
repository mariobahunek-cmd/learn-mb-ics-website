...
When a company buys something — raw materials for production, consumables for the office, or a service — that transaction almost always follows the same path in SAP: **Procure-to-Pay**, or **P2P** for short. This article walks through the journey from the first demand to the final payment, step by step, with the terms you keep running into in SAP procurement.

## In short: the full path from demand to payment
...
- whether a delivery has already arrived for an order item
- whether an invoice has already been entered
- whether outstanding deliveries need to be chased with the supplier
...
- The stock of the material increases.
